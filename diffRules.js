...
module.exports = {
    ...
    'exp': (args, meta) => [
        ...
        `Табличная производная <i>exp</i> и домножение на аргумент`
    ],
    'ln': (args, meta) => [
        `(${args[0].toString()})' / (${args[0].toString()})`,
        `Табличная производная <i>ln</i> и домножение на аргумент`
    ],
    'sqrt': (args, meta) => [
        `(${args[0].toString()})' / 2 / sqrt(${args[0].toString()})`,
        `Табличная производная <i>sqrt</i> и домножение на аргумент`
    ],

    'sin': (args, meta) => [
        `cos(${args[0].toString()}) * (${args[0].toString()})'`,
        `Табличная производная <i>sin</i> и домножение на аргумент`
    ],
    'cos': (args, meta) => [
        `-sin(${args[0].toString()}) * (${args[0].toString()})'`,
        `Табличная производная <i>cos</i> и домножение на аргумент`
    ],
    'tg': (args, meta) => [
        `(${args[0].toString()})' / cos(${args[0].toString()})^2`,
        `Табличная производная <i>tg</i> и домножение на аргумент`
    ],
    'ctg': (args, meta) => [
        `-(${args[0].toString()})' / sin(${args[0].toString()})^2`,
        `Табличная производная <i>ctg</i> и домножение на аргумент`
    ],

    'arcsin': (args, meta) => [
        `(${args[0].toString()})' / sqrt(1 - (${args[0].toString()})^2)`,
        `Табличная производная <i>arcsin</i> и домножение на аргумент`
    ],
    'arccos': (args, meta) => [
        `-(${args[0].toString()})' / sqrt(1 - (${args[0].toString()})^2)`,
        `Табличная производная <i>arccos</i> и домножение на аргумент`
    ],
    'arctg': (args, meta) => [
        `(${args[0].toString()})' / (1 + (${args[0].toString()})^2)`,
        `Табличная производная <i>arctg</i> и домножение на аргумент`
    ],
    'arcctg': (args, meta) => [
        `-(${args[0].toString()})' / (1 + (${args[0].toString()})^2)`,
        `Табличная производная <i>arcctg</i> и домножение на аргумент`
    ],
}